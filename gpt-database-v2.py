             ...
             try:
                 ...
                 if user and assistant:
                    ...
                    fine_tuning_data.append({
                        "messages": [
                            {"role": "system", "content": "You are an assistant specialized in e-commerce and must provide exactly the product description as stated in the training."},
...
output_file = 'data/dataset2.jsonl'
